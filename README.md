...
## 부부
#### 카카오 로그인
<b>예비 부부는 카카오 소셜 로그인을 통해 Marrymo에 로그인 가능</b>
|카카오 로그인 화면|
|:---:|
|홈 사진|
...
<b>모바일 청첩장 정보를 등록 하지 않았을 때는 모바일 청첩장 정보를 등록할 수 있도록 해당 페이지로 이동 시킴</b>
|청첩장 정보를 등록 했을 경우|청첩장 정보를 등록하지 않았을 경우|
|:---:|:---:|
|사진|사진|
...
## 하객
#### 모바일 청첩장 조회
<b>하객은 예비 부부가 공유한 링크로부터 랜딩 페이지로 이동하여 모바일 청첩장 조회 가능</b>
|모바일 청첩장 조회|
|:---:|
|사진|
