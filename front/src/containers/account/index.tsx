  ...
  return (
    <>
      ...
      <main className={styles.accountWrapper}>
        <div>
          <h2>계좌는 왜 등록하나요?</h2>
          <div>- 메리모는 고객님 만든 모바일 청첩장에 사용할 계좌 번호가 필요해요.</div>
          <div>- 메리모는 <strong>금융 결제원의 오픈API</strong>와 <strong>카카오페이 송금하기 서비스</strong>를 연동해 고객님의 <strong>축의금을 안전하게 관리</strong>해요.</div>
